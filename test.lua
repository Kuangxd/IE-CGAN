-- usage: DATA_ROOT=datasets/EN/ name=EN which_direction=BtoA phase=256_256 th test.lua
--
...
opt = {
    ...
    loadSize_h = 256,           -- scale images to this size
    loadSize_w = 256,
    fineSize_h = 256,           --  then crop to this size
    fineSize_w = 256,           --  then crop to this size
...
opt.fineSize_h = opt.loadSize_h
opt.fineSize_w = opt.loadSize_w
